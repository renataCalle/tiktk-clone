...
import Logo from '../utils/hypeclap-logo.png';
    ...
    items-center border-b-2 border-gray-200 py-2 px-4'>
      ...
      <div className='relative hidden md:block'>
        ...
        className='absolute md:static top-10 -left-20 bg-white'>
          ...
          focus:border-gray-300 w-[300px] md:w-[350px] md:top-0 rounded-full'
          />
          <button
          onClick={handleSearch}
          className='absolute md:right-5 top-4 border-l-2 border-gray-300 
      ...
      <div>
        {userProfile ? (
          <div className='flex gap-5 md:gap-10'>
            <Link href="/upload">
              <button className='border-2 px-2 md:px-4 text-md
